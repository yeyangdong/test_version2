...
class TestRegister(unittest.TestCase):
    ...
    def test_register_success(self):
        ...
        try:
            self.assertEqual(expected_value,actual,'{"code":2,"msg":"账号已存在","data":null,"copyright":"Copyright 柠檬班 © 2017-2020 湖南省零檬信息技术有限公司 All Rights Reserved"}')
